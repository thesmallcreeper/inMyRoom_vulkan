...
namespace std
{
    template <> struct hash<ShadersSpecs>
    {
    ...
    template <> struct equal_to<ShadersSpecs>
    {
...
{
public:
    PrimitivesShaders(std::vector<ShaderSetFamilyInitInfo> in_shadersSetFamilyInitInfos, Anvil::BaseDevice* in_device_ptr);
    ~PrimitivesShaders();
