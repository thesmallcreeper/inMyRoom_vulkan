...
public:
    ...
    "ParentEntity",         parent_entity           = Entity        (optional)
    ...
    */
    static NodeGlobalMatrixCompEntity CreateComponentEntityByMap(const Entity in_entity, const ComponentEntityInitMap in_map);
