...
void NodesMeshes::Draw(size_t in_mesh, uint32_t in_meshDeviceID, size_t in_primitivesSet_index,
                       ...
                       std::vector<Anvil::DescriptorSet*> in_low_descriptor_sets_ptrs)
{
    ...
    for (size_t primitiveIndex = this_meshRange.primitiveFirstOffset; primitiveIndex < this_meshRange.
         primitiveFirstOffset + this_meshRange.primitiveRangeSize; primitiveIndex++)
    {
