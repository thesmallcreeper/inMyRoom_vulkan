...
std::pair<glm::vec3, glm::vec3> RayDeltaUncollide::ExecuteRayDeltaUncollide(const CSentriesPairCollisionCenter& this_entriesPaircollisionCenter) const
{
    ...
    RayTriangleIntersectInfo first_to_second_intersect = first_to_second_ray.IntersectOBBtree(*reinterpret_cast<const OBBtree*>(this_entriesPaircollisionCenter.secondEntry.OBBtree_ptr),
    ...
    {
        Triangle best_triangle_first_to_second_worldspace = this_entriesPaircollisionCenter.secondEntry.currentGlobalMatrix * first_to_second_intersect.triangle;
    ...
    RayTriangleIntersectInfo second_to_first_intersect = second_to_first_ray.IntersectOBBtree(*reinterpret_cast<const OBBtree*>(this_entriesPaircollisionCenter.firstEntry.OBBtree_ptr),
    ...
    {
        Triangle best_triangle_second_to_first_worldspace = this_entriesPaircollisionCenter.firstEntry.currentGlobalMatrix * second_to_first_intersect.triangle;
